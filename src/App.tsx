...
const seoByPage: Record<string, SeoConfig> = {
  ...
  about: {
    ...
    description:
      "Learn about Kijana Simama, our mission, vision, founders council, Board of Director, and commitment to empowering in-school adolescents across Tanzania.",
    keywords:
      "about Kijana Simama, Kijana Simama founders, youth NGO Tanzania, adolescent wellbeing Tanzania, Board of Director",
    path: "/about",
  },
  services: {
